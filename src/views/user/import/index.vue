<template>
  <div class="app-container">
    ...
    <el-button  type="primary" style="width:10%;margin-bottom:30px;" @click="handlechange">导出就业数据</el-button>
    <el-table
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="150">
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini"  @click="submitForm(scope.row.id, 0)">撤销</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    <el-drawer
      ...
      direction="rtl">
       ...
       <el-button type="primary" @click="submitForm(josInfo.id, 0)">撤销</el-button>
    </el-drawer>
  </div>
</template>

<script>
  import {page, delObj, updObj,checkDetail,checkCompany,getSeccess} from '@/api/user/index'
  ...
  export default {
    ...
    methods: {
      ...
      handlechange(){
        ...
        a.setAttribute('href', '/dev-api/studentJos/excel/1/' +　getToken())
